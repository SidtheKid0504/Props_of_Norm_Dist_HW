...
df = pd.read_csv('./hwFiles/data/StudentsPerformance.csv')
m_list = df["math score"].to_list()
m_mean = sts.mean(m_list)
m_median = sts.median(m_list)
m_mode = sts.mode(m_list)

print("Mean, Median and Mode of math score is {}, {} and {} respectively".format(m_mean,m_median,m_mode))

m_sd = sts.stdev(m_list)
